...
$(TASK_CHAPTER_12_2_CHUNK_ID): $(PROGRAM_NAME).nw
	notangle -R$(TASK_CHAPTER_12_2_CHUNK_ID) $(PROGRAM_NAME).nw > $(TASK_CHAPTER_12_2_FILENAME)

$(TASK_CHAPTER_12_3_CHUNK_ID): $(PROGRAM_NAME).nw
	notangle -R$(TASK_CHAPTER_12_3_CHUNK_ID) $(PROGRAM_NAME).nw > $(TASK_CHAPTER_12_3_FILENAME)

$(TASK_CHAPTER_12_4_CHUNK_ID): $(PROGRAM_NAME).nw
	notangle -R$(TASK_CHAPTER_12_4_CHUNK_ID) $(PROGRAM_NAME).nw > $(TASK_CHAPTER_12_4_FILENAME)

$(TASK_CHAPTER_12_5_CHUNK_ID): $(PROGRAM_NAME).nw
	notangle -R$(TASK_CHAPTER_12_5_CHUNK_ID) $(PROGRAM_NAME).nw > $(TASK_CHAPTER_12_5_FILENAME)

$(TASK_CHAPTER_12_6_CHUNK_ID): $(PROGRAM_NAME).nw
	notangle -R$(TASK_CHAPTER_12_6_CHUNK_ID) $(PROGRAM_NAME).nw > $(TASK_CHAPTER_12_6_FILENAME)

$(TASK_CHAPTER_12_7_CHUNK_ID): $(PROGRAM_NAME).nw
	notangle -R$(TASK_CHAPTER_12_7_CHUNK_ID) $(PROGRAM_NAME).nw > $(TASK_CHAPTER_12_7_FILENAME)

$(TASK_CHAPTER_12_8_CHUNK_ID): $(PROGRAM_NAME).nw
	notangle -R$(TASK_CHAPTER_12_8_CHUNK_ID) $(PROGRAM_NAME).nw > $(TASK_CHAPTER_12_8_FILENAME)
	
$(TASK_CHAPTER_13_1_CHUNK_ID): $(PROGRAM_NAME).nw
	notangle -R$(TASK_CHAPTER_13_1_CHUNK_ID) $(PROGRAM_NAME).nw > $(TASK_CHAPTER_13_1_FILENAME)

$(TASK_CHAPTER_13_2_CHUNK_ID): $(PROGRAM_NAME).nw
	notangle -R$(TASK_CHAPTER_13_2_CHUNK_ID) $(PROGRAM_NAME).nw > $(TASK_CHAPTER_13_2_FILENAME)

$(TASK_CHAPTER_13_3_CHUNK_ID): $(PROGRAM_NAME).nw
	notangle -R$(TASK_CHAPTER_13_3_CHUNK_ID) $(PROGRAM_NAME).nw > $(TASK_CHAPTER_13_3_FILENAME)

$(TASK_CHAPTER_13_4_CHUNK_ID): $(PROGRAM_NAME).nw
	notangle -R$(TASK_CHAPTER_13_4_CHUNK_ID) $(PROGRAM_NAME).nw > $(TASK_CHAPTER_13_4_FILENAME)

$(TASK_CHAPTER_13_5_CHUNK_ID): $(PROGRAM_NAME).nw
	notangle -R$(TASK_CHAPTER_13_5_CHUNK_ID) $(PROGRAM_NAME).nw > $(TASK_CHAPTER_13_5_FILENAME)

$(TASK_CHAPTER_13_6_CHUNK_ID): $(PROGRAM_NAME).nw
	notangle -R$(TASK_CHAPTER_13_6_CHUNK_ID) $(PROGRAM_NAME).nw > $(TASK_CHAPTER_13_6_FILENAME)

$(TASK_CHAPTER_13_7_CHUNK_ID): $(PROGRAM_NAME).nw
	notangle -R$(TASK_CHAPTER_13_7_CHUNK_ID) $(PROGRAM_NAME).nw > $(TASK_CHAPTER_13_7_FILENAME)
...
dirs:
	mkdir -p $(SRC)/$(CHAPTER_1_DIR) $(SRC)/$(CHAPTER_2_DIR) $(SRC)/$(CHAPTER_3_DIR) $(SRC)/$(CHAPTER_4_DIR) $(SRC)/$(CHAPTER_5_DIR) $(SRC)/$(CHAPTER_6_DIR) $(SRC)/$(CHAPTER_7_DIR) $(SRC)/$(CHAPTER_8_DIR) $(SRC)/$(CHAPTER_9_DIR) $(SRC)/$(CHAPTER_10_DIR) $(SRC)/$(CHAPTER_11_DIR) $(SRC)/$(CHAPTER_12_DIR) $(SRC)/$(CHAPTER_13_DIR)
