...
all: dirs $(TASK_CHAPTER_1_1_CHUNK_ID) $(TASK_CHAPTER_1_2_CHUNK_ID) $(TASK_CHAPTER_1_3_CHUNK_ID) $(TASK_CHAPTER_1_4_CHUNK_ID)  $(TASK_CHAPTER_1_8_CHUNK_ID) $(TASK_CHAPTER_2_1_CHUNK_ID) $(TASK_CHAPTER_3_6_CHUNK_ID) $(TASK_CHAPTER_5_4_CHUNK_ID) $(PROGRAM_NAME) dist 
